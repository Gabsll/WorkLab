...
![Clique com o lado direito do mause e clique em criar novo arquivo](Criando_um_arquivo_html_1.png)

![ crie uma extenção ".html". Pode nomeá-lo como "index.html"](Criando_um_arquivo_httml_2.png)
